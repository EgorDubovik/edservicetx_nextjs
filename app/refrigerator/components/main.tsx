...
import RepairRefrigator from "../../../public/Reefrigerator.png";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
               <div className="text-center md:text-left">
                  ...
                  <p className="text-lg md:text-2xl py-10">
                     We repair all brands and models of refrigerators, <br />
                     including LG, Samsung, Whirlpool, and more.
                  </p>
               ...
               <div className="">
                  <Image
                     src={RepairRefrigator}
                     alt="refrigerator repair technician"
                     height={500}
                  />
               </div>
            </div>
