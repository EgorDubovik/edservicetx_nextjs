...
import RepairImage from "../../../public/Range.png";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
               <div className="text-center md:text-left">
                  ...
                  <p className="text-lg md:text-2xl py-10">
                     Gas &amp; electric stoves, ovens, and cooktops — <br />
                     all brands, fast and affordable.
                  </p>
               ...
               <div className="">
                  <Image
                     src={RepairImage}
                     alt="stove oven cooktop repair technician"
                     height={500}
                  />
               </div>
            </div>
